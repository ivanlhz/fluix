...
import {
	FluixMenuComponent,
	FluixMenuItemComponent,
	FluixNotchComponent,
	FluixToastService,
	FluixToasterComponent,
	FluixTooltipComponent,
} from "@fluix-ui/angular";
import type {
	FluixPosition,
	FluixToasterConfig,
	MenuOrientation,
...
export class AppComponent implements AfterViewInit, OnDestroy {
	...
	readonly menuActiveId = computed<string | null>(() => (this.menuReady() ? this.route() : null));
	...
	readonly tooltipPosition = signal<TooltipPosition>("top");
	...
	ngAfterViewInit(): void {
		...
		requestAnimationFrame(() => {
			this.layoutEntered.set(true);
		});
		this.menuReadyTimer = window.setTimeout(() => {
